    ...
    return (
        <section id="main" className="min-h-screen">
            <div className={"text-center p-10"}>
                ...
                <h2 className={"text-4xl lg:text-5xl py-2 text-teal-600 font-medium"}>Muhammad Akbar Maulana Rahmat</h2>
            ...
            <div className="flex justify-center gap-16 py-3 text-gray-300">
                <a className="justify-center bg-gradient-to-r from-cyan-700 to-teal-400 text-white text-lg px-4 py-2 rounded-full"
                   href="/CV Muhammad Akbar Maulana Rahmat.pdf"
                   target="_blank"
                   rel="noopener noreferrer"
                   download="CV Muhammad Akbar Maulana Rahmat.pdf"
                >
                    <MdOutlineFileDownload className={"mx-auto inline"} /> Download CV
                </a>
            </div>
